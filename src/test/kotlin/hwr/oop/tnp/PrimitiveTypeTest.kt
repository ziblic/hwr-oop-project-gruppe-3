...
class PrimitiveTypeTest : AnnotationSpec() {
    @Test
    fun `Test type WATER is effective against FIRE and less effective against PLANT`() {
        ...
        assertThat(monsterType.lessEffectiveAgainst).isEqualTo(PrimitiveType.PLANT)
    }
    ...
    fun `Test type FIRE is effective against PLANT and less effective against WATER`() {
        ...
        assertThat(monsterType.lessEffectiveAgainst).isEqualTo(PrimitiveType.WATER)
    }
    ...
    fun `Test type PLANT is effective against WATER and less effective against FIRE`() {
        ...
        assertThat(monsterType.lessEffectiveAgainst).isEqualTo(PrimitiveType.FIRE)
    }

    @Test
    fun `Test type SPIRIT has no effect against NORMAL`() {
        assertThat(PrimitiveType.SPIRIT.noEffectAgainst).isEqualTo(PrimitiveType.NORMAL)
    }
