...
//       Trainer("Alex", MutableList(MAX_ALLOWED_MONSTERS_PER_TRAINER + 1) { monster })
//     }
//   }
//
//   @Test
...
//
//     val exception = assertThrows<IllegalArgumentException> { trainer.addMonster(monster) }
//
//     assertThat(exception.message)
//             .isEqualTo("Too many monsters: maximum allowed is $MAX_ALLOWED_MONSTERS_PER_TRAINER")
//     assertThat(trainer.monsters.size).isEqualTo(MAX_ALLOWED_MONSTERS_PER_TRAINER)
//   }
//
//   @Test
